...
void MainWindow::power_rpm(){
    ...
    command="/bin/./halcmd setp trajectory.power_rpm_in ";
...
void MainWindow::m3_on(){
    ...
    command="/bin/./halcmd setp trajectory.m3_in 1";
    result=path_to_lcnc_bin+command;
    system(result.c_str());
}
...
void MainWindow::m3_off(){
    ...
    command="/bin/./halcmd setp trajectory.m3_in 0";
    result=path_to_lcnc_bin+command;
    system(result.c_str());
}
...
void MainWindow::m7_on(){
    ...
    command="/bin/./halcmd setp trajectory.m7_in 1";
    result=path_to_lcnc_bin+command;
    system(result.c_str());
}
...
void MainWindow::m7_off(){
    ...
    command="/bin/./halcmd setp trajectory.m7_in 0";
    result=path_to_lcnc_bin+command;
    system(result.c_str());
}
...
void MainWindow::m8_on(){
    ...
    command="/bin/./halcmd setp trajectory.m8_in 1";
    result=path_to_lcnc_bin+command;
    system(result.c_str());
}
...
void MainWindow::m8_off(){
    ...
    command="/bin/./halcmd setp trajectory.m8_in 0";
    result=path_to_lcnc_bin+command;
    system(result.c_str());
}
...
void MainWindow::max_values(){
    ...
    command="/bin/./halcmd setp trajectory.max_velocity ";
    value=ui->lineEdit_max_velocity->text().toDouble();
    result=path_to_lcnc_bin+command+std::to_string(value);
    system(result.c_str());

    command="/bin/./halcmd setp trajectory.max_acceleration ";
    value=ui->lineEdit_max_acceleration->text().toDouble();
    result=path_to_lcnc_bin+command+std::to_string(value);
    system(result.c_str());

    command="/bin/./halcmd setp trajectory.max_jerk ";
...
void MainWindow::tooloffset(){
    ...
    command="/bin/./halcmd setp trajectory.tcp_offset_x ";
    value=ui->lineEdit_tooloffset_x->text().toDouble();
    result=path_to_lcnc_bin+command+std::to_string(value);
    system(result.c_str());

    command="/bin/./halcmd setp trajectory.tcp_offset_y ";
    value=ui->lineEdit_tooloffset_y->text().toDouble();
    result=path_to_lcnc_bin+command+std::to_string(value);
    system(result.c_str());

    command="/bin/./halcmd setp trajectory.tcp_offset_z ";
...
void MainWindow::gcodeblock(){
    ...
    command="/bin/./halcmd setp trajectory.start_from_gcodeblock ";
...
void MainWindow::mode_auto_stop_pressed(){
    ...
    command="/bin/./halcmd setp trajectory.stop 1";
    result=path_to_lcnc_bin+command;
    system(result.c_str());
...
void MainWindow::mode_auto(){
    ...
    command="/bin/./halcmd setp trajectory.mode_auto 1";
    result=path_to_lcnc_bin+command;
    system(result.c_str());
...
void MainWindow::mode_jog(){
    ...
    command="/bin/./halcmd setp trajectory.mode_jog 1";
    result=path_to_lcnc_bin+command;
    system(result.c_str());
...
void MainWindow::jog_x_plus_pressed(){
    std::string path_to_lcnc_bin=ui->lineEdit_path_to_lcnc_bin->text().toStdString();
    std::string command="/bin/./halcmd setp trajectory.jog_x_plus 1";
...
void MainWindow::jog_x_min_pressed(){
    std::string path_to_lcnc_bin=ui->lineEdit_path_to_lcnc_bin->text().toStdString();
    std::string command="/bin/./halcmd setp trajectory.jog_x_min 1";
    std::string result=path_to_lcnc_bin+command;
    system(result.c_str());
}
...
void MainWindow::jog_y_min_pressed(){
    std::string path_to_lcnc_bin=ui->lineEdit_path_to_lcnc_bin->text().toStdString();
    std::string command="/bin/./halcmd setp trajectory.jog_y_min 1";
    std::string result=path_to_lcnc_bin+command;
    system(result.c_str());
}
...
void MainWindow::jog_y_plus_pressed(){
    std::string path_to_lcnc_bin=ui->lineEdit_path_to_lcnc_bin->text().toStdString();
    std::string command="/bin/./halcmd setp trajectory.jog_y_plus 1";
    std::string result=path_to_lcnc_bin+command;
    system(result.c_str());
}
...
void MainWindow::jog_z_min_pressed(){
    std::string path_to_lcnc_bin=ui->lineEdit_path_to_lcnc_bin->text().toStdString();
    std::string command="/bin/./halcmd setp trajectory.jog_z_min 1";
    std::string result=path_to_lcnc_bin+command;
    system(result.c_str());
}
...
void MainWindow::jog_z_plus_pressed(){
    std::string path_to_lcnc_bin=ui->lineEdit_path_to_lcnc_bin->text().toStdString();
    std::string command="/bin/./halcmd setp trajectory.jog_z_plus 1";
    std::string result=path_to_lcnc_bin+command;
    system(result.c_str());
}
...
void MainWindow::jog_x_min_released(){
    std::string path_to_lcnc_bin=ui->lineEdit_path_to_lcnc_bin->text().toStdString();
    std::string command="/bin/./halcmd setp trajectory.jog_x_min 0";
    std::string result=path_to_lcnc_bin+command;
    system(result.c_str());
}
...
void MainWindow::jog_y_min_released(){
    std::string path_to_lcnc_bin=ui->lineEdit_path_to_lcnc_bin->text().toStdString();
    std::string command="/bin/./halcmd setp trajectory.jog_y_min 0";
    std::string result=path_to_lcnc_bin+command;
    system(result.c_str());
}
...
void MainWindow::jog_y_plus_released(){
    std::string path_to_lcnc_bin=ui->lineEdit_path_to_lcnc_bin->text().toStdString();
    std::string command="/bin/./halcmd setp trajectory.jog_y_plus 0";
    std::string result=path_to_lcnc_bin+command;
    system(result.c_str());
}
...
void MainWindow::jog_z_min_released(){
    std::string path_to_lcnc_bin=ui->lineEdit_path_to_lcnc_bin->text().toStdString();
    std::string command="/bin/./halcmd setp trajectory.jog_z_min 0";
    std::string result=path_to_lcnc_bin+command;
    system(result.c_str());
}
